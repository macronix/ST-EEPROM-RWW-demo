...
#define BANK_LEN  0x01000000
#define BANK_MASK 0xFF000000
#define BANK_BITS  24
...
#define BANKS(addr)      (((addr)&BANK_MASK)>>BANK_BITS)
...
#define SUPPORT_WRSR_CR2     0x00000200

enum AddressMode {
    SELECT_3B = 0x00, SELECT_4B = 0x01, ADDR_MODE_AUTO_SEL = 0x03,
};
...
#define CR2_BANK_STATUS_ADDR    0x80000100
...
enum MX_CMD_ID_REG_CMDS {
    ...
    MX_QPIID = 0x00000020, MX_RDID = 0x00000040,
...
enum MX_CMD_RD_CMDS {
    ...
    MX_FREAD = 0x00100000, MX_DREAD4B = 0x00200000, /* 1-1-2 FAST READ 4-byte addressing */
    ...
    MX_4B_RD = (MX_READ4B | MX_FASTREAD4B | MX_2READ4B | MX_4READ4B | MX_DREAD4B
            | MX_QREAD4B)
};
...
#define MX_ERS_CMDS_MASK 0xFFFF0000
    ...
    MX_4B_ERS = (MX_SE4B | MX_BE32K4B | MX_BE4B), MX_4B_PGMERS = (MX_4B_PGM
            | MX_4B_ERS)
};
